package org.eclipse.t2m.java2ad.ui;
...
import ma.emi.est.mde.engineering.Performer;
...
//				xfc.setFileSelectionMode(JFileChooser.DIRECTORIES_ONLY);
		...
		start.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String xmiVersion = xv.getSelectedItem().toString();
				String xmins = xn.getSelectedItem().toString();
				String umlns = un.getSelectedItem().toString();
				String target = xf.getText();
				
				new Performer(path, xmiVersion, xmins, umlns, target);
